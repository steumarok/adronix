  ...
  <q-page class="q-pa-md">
    ...
    <adx-d vertical y-spacing="sm">
        ...
        <adx-breadcrumbs separator=" > ">
            ...
            <q-breadcrumbs-el>Modelli di checklist</q-breadcrumbs-el>
        </adx-breadcrumbs>
        ...
        <adx-d>
            ...
            >
                <template #top-left>
                    <q-btn @click="onInsert" color="primary" unelevated>Inserisci modello</q-btn>
                </template>
...
import ChecklistModelEdit from './ChecklistModelEdit.vue'
...
const ds = $adx.dataSet(computed(() => buildUrl('/api/mms/listChecklistModels', dataTable.params)))

function onInsert() {
    $adx.openDialog(ChecklistModelEdit)
}

function onDelete(key: string) {
    DataSetUtils.deleteItem(ds, "MmsChecklistModel", key, () => ds.commit())
}

function onEdit(id: string) {
    $adx.openDialog(ChecklistModelEdit, { id })
}
