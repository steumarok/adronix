  ...
  <q-page class="q-pa-md">
    ...
    <adx-d vertical y-spacing="sm">
        ...
        <adx-breadcrumbs separator=" > ">
            ...
            <q-breadcrumbs-el>Modelli di attività</q-breadcrumbs-el>
        </adx-breadcrumbs>
        ...
        <adx-d>
            ...
            >
                <template #top-left>
                    <q-btn @click="onInsert" color="primary" unelevated>Inserisci modello di attività</q-btn>
                </template>
...
import TaskModelEdit from './TaskModelEdit.vue'
...
const ds = $adx.dataSet(computed(() => buildUrl('/api/mms/listTaskModels', dataTable.params)))

function onInsert() {
    $adx.openDialog(TaskModelEdit)
}

function onDelete(key: string) {
    DataSetUtils.deleteItem(ds, "MmsTaskModel", key, () => ds.commit())
}

function onEdit(key: string) {
    $adx.openDialog(TaskModelEdit, { id: key })
}
