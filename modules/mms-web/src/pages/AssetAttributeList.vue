  ...
  <q-page class="q-pa-md">
    ...
    <adx-d vertical y-spacing="sm">
        ...
        <adx-breadcrumbs separator=" > ">
            ...
            <q-breadcrumbs-el>Attributi assets</q-breadcrumbs-el>
        </adx-breadcrumbs>
...
import AssetAttributeEdit from './AssetAttributeEdit.vue'
...
const ds = $adx.dataSet(computed(() => buildUrl('/api/mms/listAssetAttributes', dataTable.params)))

function onInsert() {
    $adx.openDialog(AssetAttributeEdit)
}

function onDelete(key: string) {
    DataSetUtils.deleteItem(ds, "MmsAssetAttribute", key, () => ds.commit())
}

function onEdit(key: string) {
    $adx.openDialog(AssetAttributeEdit, { id: key })
}
